...
class thecrew extends Table
{
    ...
    protected function setupNewGame( $players, $options = array() )
    {
        ...
        foreach( $players as $player_id => $player )
        {
            ...
            if($player['player_is_premium'])
            {
                $atleastOnePremium = true;
            }
        }
        ...
        self::setGameStateInitialValue( 'intro_shown', 0 );
        self::setGameStateInitialValue( 'player_is_premium', $atleastOnePremium );
        ...
        self::setGameStateInitialValue( 'challenge', 1);
        if(count($players) == 3)
        {
